...
const IndexPage = (props) => (
  <Layout location={props.location}>
    <div>
      ...
      <p>
        Nos activités de recherche sont axées sur le développement de méthodes
        et de logiciels d’analyse bioinformatique du génome visant à identifier
        ...
        la recherche en génomique. Elle développe des outils logiciels avancés
        de traitement, recherche et visualisation à grande échelle des données
        génomiques dans des environnements de calcul info-nuagiques. Nous
        travaillons notamment sur la construction de plusieurs projets
        d’infrastructures de recherche et cliniques dont celles du NIH Gabriella
        Miller Kids First Data Resource Center, le Centre québécois de données
        génomiques et le Centre québécois de génomique clinique.
      </p>
    </div>
    <div>
